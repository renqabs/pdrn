...
RUN curl -LO https://github.com/pandora-next/deploy/releases/download/v0.2.0/PandoraNext-v0.2.0-linux-arm64-f1585a2.tar.gz \
    && tar -xzf PandoraNext-v0.2.0-linux-arm64-f1585a2.tar.gz --strip-components=1 \
    && rm PandoraNext-v0.2.0-linux-arm64-f1585a2.tar.gz \
    && chmod 777 -R .
